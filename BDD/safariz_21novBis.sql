...
--
-- Client :  localhost
-- Généré le :  Mar 21 Novembre 2017 à 15:32
...
INSERT INTO `gagnants` (`gagnant_id`, `client_id`, `dateGain`, `lot_id`) VALUES
(2, 1, '2017-11-21 14:37:39', 1);
...
--
ALTER TABLE `gagnants`
  MODIFY `gagnant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
